...
export const refresh = () => api.post("/token/refresh/", { refresh: localStorage.getItem("refresh") });
export const register = (payload) => api.post("/register/", payload);
// ---------- PROFILE ----------
export const me = () => api.get("/me/profile/");
// ---------- SKILLS ----------
export const getSkills = () => api.get("/skills/"); // list all global skills
export const createSkill = (payload) => api.post("/skills/", payload); // create a new skill
export const listUserSkills = () => api.get("/user-skills/"); // get logged-in user's skills
export const addUserSkill = (payload) => api.post("/user-skills/", payload); // link skill to user
export const deleteUserSkill = (id) => api.delete(`/user-skills/${id}/`); // remove skill from user
// ---------- SWIPE / MATCHES / CREDITS ----------
export const suggestions = () => api.get("/suggestions/");
export const createSwipe = (body) => api.post("/swipes/create_swipe/", body);
